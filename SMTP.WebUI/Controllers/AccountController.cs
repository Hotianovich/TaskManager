...
namespace SMTP.WebUI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private IEmployee<Employee> _reposytoryEmployee;
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    _reposytoryEmployee.CreateAfterRegistration(model.Email, model.NickName);
                    var employee = _reposytoryEmployee.GetForRegistration(model.Email);
                    _repositoryUser_Employee.Create(user, employee);
